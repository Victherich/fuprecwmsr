...
const Fill_inMarkingModal = ({
  ...
  /* ================= FETCH Fill_in ================= */
  useEffect(() => {
    const fetchFill_in = async () => {
      try {
        const res = await axios.get(
          "https://www.cwmsrfupre.com.ng/base/get_Fill_in_submission_for_marking.php",
          {
        ...
        Swal.fire("Error", "Failed to load Fill_in submission", "error");
        onClose();
      } finally {
        setLoading(false);
      }
  ...
  const saveMarks = async () => {
    try {
      await axios.post(
        "https://www.cwmsrfupre.com.ng/base/mark_Fill_in_submission.php",
        {
      ...
      Swal.fire("Success", "Fill_in marked successfully", "success");
      onSaved();
      onClose();
    } catch (err) {
...
export default Fill_inMarkingModal;
