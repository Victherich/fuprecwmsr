...
import AddFill_inQuestionModal from "./AddFill_inQuestionModal";
...
/* ================= COMPONENT ================= */
const Fill_inExamQuestionsModal = ({ exam, onClose }) => {
...
export default Fill_inExamQuestionsModal;
